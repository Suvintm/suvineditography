...
const Header = () => {
  ...
  return (
    <div className="pt-10 h-100 sm:bg-black  bg-gradient-to-b from-black  to-black w-full rounded-[12px] sm:pt-45 sm:h-140 items-center-safe justify-center-safe text-center">
      {/* Search Bar */}
      ...
      <div className="flex flex-row justify-between gap-2 sm:gap-4">
        ...
        <div className="text-center p-2 sm:p-6 w-1/2 sm:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-zinc-500 text-[15px] sm:text-3xl">
            Creative editing at your fingertips.
          </p>
        </div>

        {/* Right: Swiper Carousel */}
        <div className="sm:m-20 sm:absolute sm:w-72 sm:h-72 sm:items-center h-40 shadow-2xl shadow-black rounded-2xl mt-8 mr-8 border-1 border-white/30 text-center sm:right-30 overflow-hidden relative  flex flex-col">
          <Swiper
            modules={[Autoplay]}
          ...
          {/* ✅ Text outside image */}
          <p className=" mt-3 text-white font-bold text-sm sm:text-lg pb-2">
      ...
      {/* Bottom Section */}
      <div className="text-center p-10 mt-1 w-full flex-col  items-center-safe justify-center text-white">
        <button
          onClick={handleScrollToTools}
          className="flex  items-center-safe gap-2 bg-gradient-to-r cursor-pointer from-black via-black to-black sm:text-[20px] border-1 border-zinc-600 shadow-4xl shadow-black font-semibold px-2 py-2 sm:px-12 sm:py-4 rounded-3xl text-[15px]"
        >
          <ArrowBigDownDashIcon className="animate-bounce w-4 h-4" /> Get
          Started
        </button>
