...
const FreeToolsContainer = () => {
  return (
    <section className="relative py-10 px-4 sm:px-8 rounded-3xl bg-zinc-800 mb-5">
      {/* Free Tools Label */}
      <div className="absolute top-2 left-4 sm:left-8 bg-green-600 text-white pl-3 sm:pl-4 py-2 w-[180px] sm:w-[200px] rounded-xl shadow-lg">
